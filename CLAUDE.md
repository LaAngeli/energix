...
# Context proiect Energix

Totul de mai jos e în afara blocului Boost, deci supraviețuiește la `php artisan boost:update`.

**Citește aceste fișiere înainte de a atinge codul.** Sunt sursa de adevăr pentru
proiect; nu deduce contextul din cod.

- @.claude/context/PROJECT.md — ce construim, stack verificat, capcane de mediu, rute
- @.claude/context/BUSINESS.md — nișa, servicii, **excluderi obligatorii**, ton
- @.claude/context/CONTACT.md — telefon, email, social, GTM, SMTP
