        ...
        <div class="relative mx-auto max-w-6xl px-5 pt-8 pb-14 sm:px-8 sm:pb-18">
            ...
            <div class="mt-10 grid gap-10 lg:grid-cols-[1.1fr_auto] lg:items-center">
                <div>
                    ...
                    <p class="mt-6 max-w-2xl text-lead text-paper-dim">{{ __('site.common.response_time') }}</p>
                </div>
        ...
        <div class="grid gap-14 lg:grid-cols-[0.85fr_1.15fr] lg:gap-20">
            ...
            <div>
                <div class="nameplate bg-ink-raised p-6" data-reveal>
                    <p class="eyebrow">{{ __('site.common.phone') }}</p>
                    <a
                        href="tel:{{ $contact['phone_href'] }}"
                        class="readout mt-3 block text-readout text-gold transition hover:brightness-110"
                    >{{ $contact['phone'] }}</a>
                    <p class="mt-3 text-sm text-paper-dim">{{ __('site.common.response_time') }}</p>
                </div>

                <div class="mt-6 space-y-6" data-reveal>
                    <div>
                        <p class="eyebrow">{{ __('site.common.email') }}</p>
                    ...
                    <div>
                        <p class="eyebrow">{{ __('site.contact_page.where') }}</p>
                        <p class="mt-2 text-paper">{{ __('site.common.area_served') }}</p>
                        <p class="text-sm text-paper-dim">{{ __('site.contact_page.where_detail') }}</p>
                    </div>

                    <div>
                        <p class="eyebrow">{{ __('site.common.schedule') }}</p>
                    ...
                    <div>
                        <p class="eyebrow">{{ __('site.common.find_us') }}</p>
            ...
            <div data-reveal>
                <h2 class="text-h2 text-paper">{{ __('site.contact_page.form_title') }}</h2>
                <p class="mt-3 text-paper-dim">{{ __('site.contact_page.form_intro') }}</p>
