...
| si urca in cadru o singura data, la incarcare.
--}}
<div class="slide-up-once fixed inset-x-0 bottom-0 z-40 border-t border-line bg-ink/95 backdrop-blur lg:hidden" style="padding-bottom: env(safe-area-inset-bottom)">
    <div class="flex gap-2 p-3">
        <a
            href="tel:{{ config('energix.contact.phone_href') }}"
            class="energize-sweep flex flex-1 items-center justify-center gap-2 rounded-sm bg-gold px-4 py-3.5 font-mono text-sm font-medium text-ink tabular-nums"
        >
