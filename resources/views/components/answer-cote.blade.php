...
| La hover, linia de indicație crește — cota se „măsoară”.
|
| Regula de paleta: pe foaia luminoasa auriul apare DOAR ca hairline (1.3:1 ca
| text, pica WCAG). Raspunsul e in `graphite`. Cyan-ul nu apare deloc aici.
--}}
<div {{ $attributes->class('relative pt-6') }} data-reveal data-cote>
